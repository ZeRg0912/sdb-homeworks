...
CREATE TABLE users_core (
    ...
    CONSTRAINT chk_users_core_shard3 CHECK (user_id >= 2000001)
);
...
CREATE TABLE users_auth (
    ...
    CONSTRAINT chk_users_auth_shard3 CHECK (user_id >= 2000001)
);
...
CREATE TABLE books_core (
    ...
    year INT,
    CONSTRAINT chk_books_core_shard3 CHECK (book_id >= 1000001)
);
...
CREATE TABLE books_text (
    book_id BIGINT PRIMARY KEY,
    description TEXT,
    CONSTRAINT chk_books_text_shard3 CHECK (book_id >= 1000001)
);
...
CREATE TABLE shops_core (
    ...
    manager VARCHAR(255),
    CONSTRAINT chk_shops_core_shard3 CHECK (shop_id >= 200001)
);
...
CREATE TABLE shops_info (
    ...
    CONSTRAINT chk_shops_info_shard3 CHECK (shop_id >= 200001)
);
